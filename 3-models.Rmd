...
model <- brm(
  ...
  # priors 
  prior = c(
    prior(uniform(1.05, 1.2), nlpar = "r", lb = 1.05, ub = 1.2),  
...
Another thought I had was to re-parameterize theta so that it wasn't 1/theta, but that it is just inv_theta - priors from 1/-0.5 to 1/5 - see what happens, may also need to be log transformed? It seemed to have a minor effect, look into this more.. 
