...
pairs(power_model)
pp_check(power_model, ndraws = 30)
```
...
Using gamma or Gaussian errors doesn't change the general fit or parameter estimates. Gaussian probably makes sense from a more general theoretical perspective? 
