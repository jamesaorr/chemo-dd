...
CC <- CC %>%
  ...
  # multiply by 10^dilution factor to get CFUs per ml 
  # first row is 100ul of sample so it would be: count * 10 ^ 1 to get 1ml
  # six row would be: count * 10 ^ 6 to get to 1ml
