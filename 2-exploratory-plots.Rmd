...
This notebook uses the processed data from `1-organation.Rmd` for exploratory plotting.
...
ggplot(chibio_plot, aes(x = hours, y = od_measured, 
  ...
  scale_color_gradient(low = "#185266", high = "#3BDCB4") +
