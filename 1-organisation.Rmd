...
# there were isues with the CFU data from day 3 of dd6 - serial dilution probably went wrong for two data points that were an order of magnitude higher than all other data. 
...
Based on these observations (clearly shown in plots in `2-plots.RMD`), I'll go with 0.1 and 0.75 as the two cutoffs. The sensitivity of our results to these choices can be easily tested later on. 
